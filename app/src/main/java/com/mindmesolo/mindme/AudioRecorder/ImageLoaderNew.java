...
public class ImageLoaderNew {
    ...
    public void into(final ImageView target) {
        ...
        viewTreeObserver.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
            public boolean onPreDraw() {
                ...
                new ImageLoaderNew.ImageLoaderNewThread(target, url).start();
    ...
    public static class Builder {
        ...
        public ImageLoaderNew.Builder load(String url) {
            imageLoader.url = url;
            return this;
        }

        public ImageLoaderNew build() {
            return imageLoader;
        }
    }

    private class ImageLoaderNewThread extends Thread {

        private ImageView target;
        private String url;
        private Handler mainHandler = new Handler(Looper.getMainLooper());

        private ImageLoaderNewThread(ImageView target, String url) {
            this.target = target;
            this.url = url;
        }
