...
/**
 * Created by enest_09 on 1/19/2017.
 */
...
public class ContactsAdapter extends ArrayAdapter<Contacts> {
    ...
    public ContactsAdapter(Context context, int textViewResourceId, ArrayList<Contacts> countryList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bitmap = dataHelper.decodeBase64(contacts.getImageBase64());
        if (bitmap == null) {
