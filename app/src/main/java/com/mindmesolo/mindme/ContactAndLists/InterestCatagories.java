 ...
 */
public class InterestCatagories extends Fragment {

    private static final String TAG = "InterestCatagories";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ch1 = (CheckBox) rootView.findViewById(R.id.checkbox);
    ...
    public ArrayList<Contacts> setupListView() {
        ...
        ArrayList<String> allInterestNames = sqliteDataBaseHelper.getAllInterestNames();

        Collections.sort(allInterestNames, String.CASE_INSENSITIVE_ORDER);

        for (String listName : allInterestNames) {

            String ListId = sqliteDataBaseHelper.getInterestIdFromName(listName);

            ArrayList<String> InterestsContacts = dataHelper.stringToArrayList(sqliteDataBaseHelper.getAllInterestContactIds(ListId));

            ContactsList.add(new Contacts(String.valueOf(InterestsContacts.size()), listName, InterestsContacts, ListId, getContactInList(InterestsContacts)));
    ...
    private void AddContactInInterests(final Contacts contacts, int RequestMethod) {
        ...
        String URl = OrganizationModel.getApiBaseUrl() + getOrgId() + "/interests/" + contacts.getId() + "/contacts";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            sqliteDataBaseHelper.updateInterestContactsAndLength(contacts.getId(), mJSONArray.toString(), (mJSONArray.length()));
    ...
    private void updateContactFromList(Contacts contacts) {
        ...
        mCallback.AddContact_In_List_Interest_Tags(jsonObject, "interests");
        dataAdapter.notifyDataSetChanged();
    }
                ...
                holder.checkBox.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        if (cb.isChecked()) {
                            ...
                            AddContactInInterests(contacts, POST);
                            contacts.setSelected(true);
                        } else {
                            //Request method DELETE = 3;
                            //AddContactInInterests(contacts,DELETE);
