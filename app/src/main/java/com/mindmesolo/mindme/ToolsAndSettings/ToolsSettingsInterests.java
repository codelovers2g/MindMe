 ...
 */
public class ToolsSettingsInterests extends AppCompatActivity {
    ...
    String TAG = "ToolsSettingsInterests";
    ...
    View.OnClickListener fabBtnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            try {
                Intent intent = new Intent(getBaseContext(), AddInterest.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title_of_page.setText("Interests");
    ...
    private void setUpUiComponents() {
        ...
        arrayList = dBhelper.getInterestNameIdLength();
    ...
    private void deleteInterestById(ListViewItem InterestId) {
        final String interestId = InterestId.getId();
        final String interestName = InterestId.getName();
        showProgressDialog("Deleting " + interestName);
        final String token = GetApiAccess();
        String org_id = dBhelper.getOrganizationId();
        RequestQueue requestQueue = Volley.newRequestQueue(getBaseContext());
        JsonObjectRequest JsonObjectRequest = new JsonObjectRequest(Request.Method.DELETE, OrganizationModel.getApiBaseUrl() + org_id + "/interests/" + interestId + "",
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        dBhelper.removeInterestById(interestId);
                        setUpUiComponents();
                        pDialog.dismiss();
                    }
                },
    ...
    //confirm if user wants remove Interest
    private void removeInterestConfirm(final ListViewItem InterestId) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(ToolsSettingsInterests.this);
        alertDialog.setMessage("Are you sure want to remove this Interest?");
        alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                deleteInterestById(InterestId);
            }
        });
                            ...
                            popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                                ...
                                public boolean onMenuItemClick(MenuItem item) {
                                    ...
                                    if (id == R.id.actionUpdate) {
                                        ...
                                        Intent intent = new Intent(getBaseContext(), UpdateInterests.class);
                                        intent.putExtra("InterestId", contactsList.get(position).getId());
                                        intent.putExtra("InterestName", contactsList.get(position).getName());
                                        startActivity(intent);
                                    }
                                    if (id == R.id.actionDelete) {
                                        popupIsVisible = false;
                                        removeInterestConfirm(contactsList.get(position));
            ...
            holder.name.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!contactsList.get(position).getLength().equals("0")) {
                        ...
                        ToastShow.setText(getBaseContext(), "No data in " + contactsList.get(position).getName(), Toast.LENGTH_LONG);
                    }
                }
            });
