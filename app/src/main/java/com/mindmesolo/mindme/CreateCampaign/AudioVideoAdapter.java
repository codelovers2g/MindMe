...
/**
 * Created by enest_09 on 12/26/2016.
 */

public class AudioVideoAdapter extends RecyclerView.Adapter<AudioVideoAdapter.MyViewHolder> implements ItemTouchHelperAdapter {
    ...
    public AudioVideoAdapter(ArrayList<CampaignData> List, OnStartDragListener mDragStartListener) {
        this.List = List;
...
//            }
    ...
    private void delete(int position) {
        if (List.get(position) != null) {
            List.remove(position);
            mDragStartListener.NotifyDataDelete();
