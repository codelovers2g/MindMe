...
typedef struct {
    void *aligned;
    /* pointer to ie. 128 bit aligned memory */
...
typedef struct {
    ...
    /* band weight long scalefactor bands, at transition */
...
#define BPC 320
    double itime[2];
    /* float precision seems to be not enough */
...
#  define  LAME_ID   0xFFF88E3B
    ...
    struct {
        unsigned int MMX:1;
        /* Pentium MMX, Pentium II...IV, K6, K6-2,
                                          K6-III, Athlon */
